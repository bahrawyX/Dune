...
function Badge({
  ...
  return (
    <Comp
      data-slot="badge"
      className={cn(badgeVariants({ variant, size }), className , "mx-1")}
      {...props}
    />
  )
}
