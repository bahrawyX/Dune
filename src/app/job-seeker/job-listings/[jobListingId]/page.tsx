...
import { JobListingApplicationTable, JobListingTable, UserResumeTable } from '@/app/drizzle/schema'
    ...
    return (
      <Popover>
        ...
        <PopoverContent className="flex flex-col gap-2">
          ...
          <Button asChild>
            <Link href="/job-seeker/user-settings/resume"><FileUser /> Upload Resume</Link>
          </Button>
        </PopoverContent>
      </Popover>
    )
